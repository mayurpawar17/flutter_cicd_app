          ...
          child: Column(
            ...
            children: [
              ...
              _buildPipelineStep(
                ...
                description:
                    'You push your Flutter code to a GitHub repository branch (e.g., main or release).',
              ...
              _buildPipelineStep(
                ...
                description:
                    'GitHub spins up a virtual machine, installs Flutter, runs unit tests, analyzes your code structure, and ensures everything compiles perfectly.',
              ...
              _buildPipelineStep(
                ...
                description:
                    'GitHub Actions hands off the build to Fastlane. Fastlane handles complex tasks like managing certificates, code signing, and compiling the final .ipa (iOS) or .apk (Android) files.',
              ...
              _buildPipelineStep(
                ...
                description:
                    'Fastlane automatically uploads the signed, finished builds to TestFlight, Google Play Console internal tracks, or public production releases.',
